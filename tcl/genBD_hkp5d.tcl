...
# TODO: Figure out what IPI is trying to do with the next 7 lines, really *why* it is trying to this?
#set folder [pwd]
...
#}
# FIXME 100 MHz for testinf
puts "FIXEM: Using 100 MHz sys0_clk"
...
connect_bd_net -net mkl2hcrt_1_m_axi_aresetn [get_bd_ports /aresetn] [get_bd_pins /axi_interconnect_1/ARESETN] [get_bd_pins /mig_1/aresetn] [get_bd_pins /axi_interconnect_1/M02_ARESETN] [get_bd_pins /axi_interconnect_1/M01_ARESETN] [get_bd_pins /axi_interconnect_1/M00_ARESETN] [get_bd_pins /mkA4LS_1/s_axi_aresetn] [get_bd_pins /mkA4LS_2/s_axi_aresetn]
connect_bd_net -net sys_rst_1 [get_bd_ports /sys_rst] [get_bd_pins /mig_1/sys_rst]
connect_bd_net -net mig_1_ui_clk [get_bd_ports /sys0_clk] [get_bd_pins /mig_1/ui_clk] [get_bd_pins /axi_interconnect_1/ACLK] [get_bd_pins /axi_interconnect_1/M00_ACLK] [get_bd_pins /axi_interconnect_1/M01_ACLK] [get_bd_pins /axi_interconnect_1/M02_ACLK] [get_bd_pins /mkA4LS_1/s_axi_aclk] [get_bd_pins /mkA4LS_2/s_axi_aclk]
connect_bd_net -net mig_1_init_calib_complete [get_bd_ports /init_calib_complete] [get_bd_pins /mig_1/init_calib_complete]
connect_bd_net -net mkl2hcrt_1_m_axi_aresetn1 [get_bd_pins /mkL2HCrt_1/m_axi_aresetn] [get_bd_pins /axi_interconnect_1/S00_ARESETN]
