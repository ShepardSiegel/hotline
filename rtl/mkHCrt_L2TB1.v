...
module mkHCrt_L2TB1(CLK,
  ...
  reg [1 : 0] CASE_crt2axicrtS0_response_get_BITS_19_TO_18__ETC__q15,
	      ...
	      CASE_l2GenFD_OUT_BITS_9_TO_8_0_l2GenFD_OUT_B_ETC__q11,
	      CASE_l2Pclient_request_get_BITS_9_TO_8_0_l2P_ETC__q10,
  ...
  begin
    case (l2P_client_request_get[9:8])
      ...
      2'd3: CASE_l2Pclient_request_get_BITS_9_TO_8_0_l2P_ETC__q10 = 2'd3;
    endcase
  end
  always@(l2GenF_D_OUT)
  begin
    case (l2GenF_D_OUT[9:8])
	  ...
	  CASE_l2GenFD_OUT_BITS_9_TO_8_0_l2GenFD_OUT_B_ETC__q11 =
	      l2GenF_D_OUT[9:8];
      2'd3: CASE_l2GenFD_OUT_BITS_9_TO_8_0_l2GenFD_OUT_B_ETC__q11 = 2'd3;
    endcase
  end
  always@(l2qc_sr)
  begin
