...
//
// On Tue Nov 12 16:25:15 EST 2013
//
...
module mkHCrt_TB1(CLK,
  ...
  // rule RL_terminate
  assign CAN_FIRE_RL_terminate = cycleCount == 16'd100 ;
  ...
  assign CAN_FIRE_RL_gcr_push_cmd =
	     gcr_xF_FULL_N && gcr_cF_EMPTY_N && gcr_cntr[1:0] == 2'd3 ;
  assign WILL_FIRE_RL_gcr_push_cmd = CAN_FIRE_RL_gcr_push_cmd ;

  // rule RL_trigger_read
  assign CAN_FIRE_RL_trigger_read = cycleCount != 16'd10 || gcr_cF_FULL_N ;
  ...
  // rule RL_gcr_incnt
  assign CAN_FIRE_RL_gcr_incnt = 1'd1 ;
  assign WILL_FIRE_RL_gcr_incnt = 1'd1 ;
  ...
  // register gcr_cntr
  assign gcr_cntr_D_IN = gcr_cntr + 8'd1 ;
  assign gcr_cntr_EN = 1'd1 ;
  ...
  assign gcr_cF_ENQ = WILL_FIRE_RL_trigger_read && cycleCount == 16'd10 ;
  ...
  begin
    case (gcr_ptr)
      12'd0: gcr_xF_D_IN = 32'h8010FFA0;
      12'd1: gcr_xF_D_IN = 32'h00000080;
  ...
  begin
	...
	gcr_cntr <= `BSV_ASSIGNMENT_DELAY 8'd0;
	...
	if (gcr_cntr_EN) gcr_cntr <= `BSV_ASSIGNMENT_DELAY gcr_cntr_D_IN;
