...
//
// On Fri May  3 10:47:38 EDT 2013
//
...
module mkHCrt_TB1(CLK,
  ...
  // register gcr_ptr
  assign gcr_ptr_D_IN = (gcr_ptr == 12'd4) ? 12'd0 : gcr_ptr + 12'd1 ;
  ...
  assign gcr_cF_ENQ =
	     ...
	     (cycleCount == 16'd0 || cycleCount == 16'd16 ||
	      cycleCount == 16'd32) ;
  assign gcr_cF_DEQ = WILL_FIRE_RL_gcr_push_cmd && gcr_ptr == 12'd4 ;
  ...
  begin
    case (gcr_ptr)
      12'd0: gcr_xF_D_IN = 32'h8003FF90;
      12'd1: gcr_xF_D_IN = 32'h0;
      12'd2: gcr_xF_D_IN = 32'h00000010;
      12'd3: gcr_xF_D_IN = 32'h00000020;
      12'd4: gcr_xF_D_IN = 32'h00000030;
