...
//
// On Sun Apr 14 17:13:09 EDT 2013
//
...
module mkHCrt_TB1(CLK,
  ...
  assign CAN_FIRE_RL_produce_commands = cmdF_FULL_N && cmdCount < 16'd10 ;
  ...
  begin
    case (cmdCount)
      16'd0, 16'd2, 16'd4, 16'd6, 16'd8: cmdF_D_IN = 32'h8001FFA0;
      16'd1: cmdF_D_IN = 32'h00000010;
      16'd3, 16'd9: cmdF_D_IN = 32'h00000024;
      16'd5: cmdF_D_IN = 32'h0;
