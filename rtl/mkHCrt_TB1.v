...
//
// On Fri Apr 12 14:40:13 EDT 2013
//
...
module mkHCrt_TB1(CLK,
  ...
  assign CAN_FIRE_RL_produce_commands = cmdF_FULL_N && cmdCount < 16'd5 ;
  ...
  begin
    case (cmdCount)
      16'd0: cmdF_D_IN = 32'h8003FF90;
      16'd1, 16'd5: cmdF_D_IN = 32'h0;
      16'd2: cmdF_D_IN = 32'h00005555;
      16'd3: cmdF_D_IN = 32'h00006666;
      16'd4: cmdF_D_IN = 32'h00007777;
      16'd6, 16'd8: cmdF_D_IN = 32'h8001FFA0;
      16'd7: cmdF_D_IN = 32'h00000004;
      16'd9: cmdF_D_IN = 32'h00000024;
