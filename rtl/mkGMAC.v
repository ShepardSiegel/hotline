...
//
// On Wed Mar 20 13:29:44 EDT 2013
//
...
// CLK_gmii_gtx_clk               O     1 clock
// CLK_GATE_gmii_gtx_clk          O     1 const
// CLK_rxclk_ModBnd               O     1 clock
...
module mkGMAC(CLK_rxClk,
  ...
  // oscillator and gates for output clock CLK_gmii_gtx_clk
  assign CLK_gmii_gtx_clk = txRS_iobTxClk_Q ;
  assign CLK_GATE_gmii_gtx_clk = 1'b1 ;

  // oscillator and gates for output clock CLK_rxclk_ModBnd
  assign CLK_rxclk_ModBnd = rxClk_BUFR_O ;
  ...
  // value method gmii_tx_tx_en
  assign gmii_tx_en = txRS_iobTxEna_Q ;

  // value method gmii_tx_tx_er
  assign gmii_tx_er = txRS_iobTxErr_Q ;
