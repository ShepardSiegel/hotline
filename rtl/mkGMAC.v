...
//
// On Tue Nov 26 08:43:19 EST 2013
//
...
// CLK_gmii_gtx_clk               O     1
// CLK_GATE_gmii_gtx_clk          O     1 const
// CLK_rxclk_ModBnd               O     1
...
module mkGMAC(CLK_rxClk,
  ...
  // oscillator and gates for output clock CLK_gmii_gtx_clk
  output CLK_gmii_gtx_clk;
  output CLK_GATE_gmii_gtx_clk;

  // oscillator and gates for output clock CLK_rxclk_ModBnd
  output CLK_rxclk_ModBnd;
  ...
  // register txRS_txDataReg
  reg [7 : 0] txRS_txDataReg;
  wire [7 : 0] txRS_txDataReg_D_IN;
  wire txRS_txDataReg_EN;

  // register txRS_txER
  reg txRS_txER;
  wire txRS_txER_D_IN, txRS_txER_EN;

  // register txRS_txEnaReg
  reg txRS_txEnaReg;
  wire txRS_txEnaReg_D_IN, txRS_txEnaReg_EN;

  // register txRS_txErrReg
  reg txRS_txErrReg;
  wire txRS_txErrReg_D_IN, txRS_txErrReg_EN;
  ...
  // oscillator and gates for output clock CLK_gmii_gtx_clk
  assign CLK_gmii_gtx_clk = CLK_txClk ;
  assign CLK_GATE_gmii_gtx_clk = 1'd1 ;

  // oscillator and gates for output clock CLK_rxclk_ModBnd
  assign CLK_rxclk_ModBnd = CLK_rxClk ;
  assign CLK_GATE_rxclk_ModBnd = 1'd1 ;
  ...
  // value method gmii_tx_txd
  assign gmii_txd = txRS_txDataReg ;

  // value method gmii_tx_tx_en
  assign gmii_tx_en = txRS_txEnaReg ;

  // value method gmii_tx_tx_er
  assign gmii_tx_er = txRS_txErrReg ;
  ...
  always@(x__h13460 or txRS_crc_result)
  begin
    case (x__h13460)
  ...
  // register rxRS_rxDV
  assign rxRS_rxDV_D_IN = gmii_rx_dv ;
  ...
  // register rxRS_rxData
  assign rxRS_rxData_D_IN = gmii_rxd ;
  assign rxRS_rxData_EN = 1'd1 ;

  // register rxRS_rxER
  assign rxRS_rxER_D_IN = gmii_rx_er ;
  ...
  assign txRS_emitFCS_D_IN =
	     MUX_txRS_emitFCS_write_1__SEL_1 ? 3'd4 : x__h13460 ;
  ...
  // register txRS_txDataReg
  assign txRS_txDataReg_D_IN = txRS_txData ;
  assign txRS_txDataReg_EN = 1'd1 ;
  ...
  // register txRS_txEnaReg
  assign txRS_txEnaReg_D_IN = txRS_txDV ;
  assign txRS_txEnaReg_EN = 1'd1 ;

  // register txRS_txErrReg
  assign txRS_txErrReg_D_IN = txRS_txER ;
  assign txRS_txErrReg_EN = 1'd1 ;
  ...
  // submodule col_cc
  assign col_cc_sD_IN = gmii_col ;
  assign col_cc_sEN = 1'd1 ;

  // submodule crs_cc
  assign crs_cc_sD_IN = gmii_crs ;
  assign crs_cc_sEN = 1'd1 ;

  // submodule intr_cc
  assign intr_cc_sD_IN = gmii_int ;
  ...
  assign txRS_preambleCnt_value_19_ULT_7___d183 =
	     txRS_preambleCnt_value < 5'd7 ;
  assign x__h13460 = txRS_emitFCS - 3'd1 ;
  ...
  begin
	...
	txRS_txEnaReg <= `BSV_ASSIGNMENT_DELAY 1'd0;
	txRS_txErrReg <= `BSV_ASSIGNMENT_DELAY 1'd0;
	...
	if (txRS_txEnaReg_EN)
	  txRS_txEnaReg <= `BSV_ASSIGNMENT_DELAY txRS_txEnaReg_D_IN;
	if (txRS_txErrReg_EN)
	  txRS_txErrReg <= `BSV_ASSIGNMENT_DELAY txRS_txErrReg_D_IN;
    ...
    if (txRS_txDataReg_EN)
      txRS_txDataReg <= `BSV_ASSIGNMENT_DELAY txRS_txDataReg_D_IN;
  end
