...
//
// On Wed Nov 27 14:07:37 EST 2013
//
...
// 	       s_sRRESP,
// 	       ctl
// Sequenced before (restricted): sts
//
// Method: s_mARADDR
// Conflict-free: s_mAWVALID,
// 	       s_sAWREADY,
...
// 	       ctl
// Sequenced before (restricted): sts
// Sequenced after (restricted): s_sARREADY
//
//
// Ports:
// Name                         I/O  size props
...
module mkA4LSB(s_axi_aclk,
  ...
  reg [63 : 0] v__h4752, v__h5094, v__h5126;
  reg [31 : 0] _theResult____h4850;
  wire [31 : 0] rdat__h5015;
  ...
  // action method sts
  assign CAN_FIRE_sts = 1'd1 ;
  assign WILL_FIRE_sts = EN_sts ;
  ...
  assign b18_EN =
	     WILL_FIRE_RL_a4l_cfwr &&
	     a4l_a4wrAddr_fifof_D_OUT[11:0] == 12'h018 &&
  ...
  assign r0_EN =
	     WILL_FIRE_RL_a4l_cfwr &&
	     a4l_a4wrAddr_fifof_D_OUT[11:0] == 12'h0 ;

  // register r4
  assign r4_D_IN = a4l_a4wrData_fifof_D_OUT[31:0] ;
  assign r4_EN =
	     WILL_FIRE_RL_a4l_cfwr &&
	     a4l_a4wrAddr_fifof_D_OUT[11:0] == 12'h004 ;

  // register r40
  assign r40_D_IN = a4l_a4wrData_fifof_D_OUT[31:0] ;
  assign r40_EN =
	     WILL_FIRE_RL_a4l_cfwr &&
	     a4l_a4wrAddr_fifof_D_OUT[11:0] == 12'h040 ;

  // register r44
  assign r44_D_IN = sts_arg ;
  assign r44_EN = EN_sts ;

  // register r8
  assign r8_D_IN = a4l_a4wrData_fifof_D_OUT[31:0] ;
  assign r8_EN =
	     WILL_FIRE_RL_a4l_cfwr &&
	     a4l_a4wrAddr_fifof_D_OUT[11:0] == 12'h008 ;
  ...
  assign a4l_a4wrResp_fifof_cntr_r_9_MINUS_1___d27 =
	     a4l_a4wrResp_fifof_cntr_r - 2'd1 ;
  assign rdat__h5015 = { b1B, b1A, b19, b18 } ;
  always@(a4l_a4rdAddr_fifof_D_OUT or
	  ...
	  axiCount or
	  rdat__h5015 or
	  lastWriteAddr or lastReadAddr or axiWtCount or axiRdCount or r40)
  begin
    case (a4l_a4rdAddr_fifof_D_OUT[11:0])
      12'h0: _theResult____h4850 = r0;
      12'h004: _theResult____h4850 = r4;
      12'h008: _theResult____h4850 = r8;
      12'h00C: _theResult____h4850 = axiCount;
      12'h010: _theResult____h4850 = 32'hF00DFACE;
      12'h014: _theResult____h4850 = 32'hFEEDC0DE;
      12'h018: _theResult____h4850 = rdat__h5015;
      12'h020: _theResult____h4850 = lastWriteAddr;
      12'h024: _theResult____h4850 = lastReadAddr;
      12'h028: _theResult____h4850 = axiWtCount;
      12'h02C: _theResult____h4850 = axiRdCount;
      12'h040: _theResult____h4850 = r40;
      default: _theResult____h4850 = r44;
    endcase
  end
  ...
  begin
    ...
    if (r44_EN) r44 <= `BSV_ASSIGNMENT_DELAY r44_D_IN;
  end
