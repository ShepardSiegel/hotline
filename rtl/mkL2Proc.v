...
//
// On Wed Feb 20 16:05:17 EST 2013
//
...
module mkL2Proc(CLK,
  ...
  // register dgRxCount
  (* mark_debug = "true" *) reg [15 : 0] dgRxCount;
  wire [15 : 0] dgRxCount_D_IN;
  wire dgRxCount_EN;

  // register dgTxCount
  (* mark_debug = "true" *) reg [15 : 0] dgTxCount;
  ...
  (* mark_debug = "true" *) wire CAN_FIRE_RL_l2Egress__dreg_update,
