...
//
// On Wed Feb  6 19:30:26 EST 2013
//
...
module mkL2Proc(CLK,
  ...
  reg [1 : 0] CASE_client_response_put_BITS_9_TO_8_0_client__ETC__q5,
	      CASE_dgRxFD_OUT_BITS_9_TO_8_0_dgRxFD_OUT_BIT_ETC__q2,
	      CASE_dgTxFD_OUT_BITS_9_TO_8_0_dgTxFD_OUT_BIT_ETC__q3,
	      CASE_l2RxFD_OUT_BITS_9_TO_8_0_l2RxFD_OUT_BIT_ETC__q4,
	      CASE_l2TxFD_OUT_BITS_9_TO_8_0_l2TxFD_OUT_BIT_ETC__q1,
	      CASE_server_request_put_BITS_9_TO_8_0_server_r_ETC__q6;
  wire [15 : 0] x__h5307;
  ...
  assign CAN_FIRE_RL_l2_ingress_payload =
	     l2RxF_EMPTY_N && dgRxF_FULL_N && !igL2Hdr ;
  ...
  assign CAN_FIRE_RL_l2_egress_header =
	     igSAF_EMPTY_N && l2TxF_FULL_N && egPtr != 4'd15 && !egPDU &&
	     dgTxF_EMPTY_N ;
  ...
  assign CAN_FIRE_RL_l2_ingress_header =
	     l2RxF_EMPTY_N && igSAF_FULL_N && igL2Hdr ;
  ...
  assign MUX_egPDU_write_1__SEL_1 =
	     WILL_FIRE_RL_l2_egress_header && igPtr == 4'd14 ;
  ...
  assign MUX_l2TxF_enq_1__SEL_1 =
	     WILL_FIRE_RL_l2_egress_header &&
	     (igPtr == 4'd1 || igPtr == 4'd2 || igPtr == 4'd3 ||
	      igPtr == 4'd4 ||
	      igPtr == 4'd5 ||
	      igPtr == 4'd6 ||
	      igPtr == 4'd7 ||
  ...
  // register egDA
  assign egDA_D_IN =
	     (igPtr == 4'd0) ? igSAF_D_OUT : { egDA[39:0], egDA[47:40] } ;
  assign egDA_EN =
	     WILL_FIRE_RL_l2_egress_header &&
	     (igPtr == 4'd0 || igPtr == 4'd1 || igPtr == 4'd2 ||
	      igPtr == 4'd3 ||
	      igPtr == 4'd4 ||
	      igPtr == 4'd5 ||
	      igPtr == 4'd6) ;
  ...
  assign egSA_EN =
	     WILL_FIRE_RL_l2_egress_header &&
	     (igPtr == 4'd0 || igPtr == 4'd7 || igPtr == 4'd8 ||
	      igPtr == 4'd9 ||
	      igPtr == 4'd10 ||
	      igPtr == 4'd11 ||
	      igPtr == 4'd12) ;
  ...
  // submodule dgTxF
  assign dgTxF_D_IN =
	     { CASE_client_response_put_BITS_9_TO_8_0_client__ETC__q5,
  ...
  assign igSAF_DEQ = WILL_FIRE_RL_l2_egress_header && igPtr == 4'd0 ;
  ...
  // remaining internal signals
  assign x__h5307 = { igSR[7:0], l2RxF_D_OUT[7:0] } ;
  always@(l2TxF_D_OUT)
  begin
  ...
  begin
    case (dgTxF_D_OUT[9:8])
	  ...
	  CASE_dgTxFD_OUT_BITS_9_TO_8_0_dgTxFD_OUT_BIT_ETC__q3 =
	      dgTxF_D_OUT[9:8];
      2'd3: CASE_dgTxFD_OUT_BITS_9_TO_8_0_dgTxFD_OUT_BIT_ETC__q3 = 2'd3;
    endcase
  end
  always@(l2RxF_D_OUT)
  begin
    case (l2RxF_D_OUT[9:8])
	  ...
	  CASE_l2RxFD_OUT_BITS_9_TO_8_0_l2RxFD_OUT_BIT_ETC__q4 =
	      l2RxF_D_OUT[9:8];
      2'd3: CASE_l2RxFD_OUT_BITS_9_TO_8_0_l2RxFD_OUT_BIT_ETC__q4 = 2'd3;
    endcase
  end
  ...
  begin
    case (client_response_put[9:8])
      ...
      2'd3: CASE_client_response_put_BITS_9_TO_8_0_client__ETC__q5 = 2'd3;
    endcase
  end
  ...
  begin
    case (server_request_put[9:8])
      ...
      2'd3: CASE_server_request_put_BITS_9_TO_8_0_server_r_ETC__q6 = 2'd3;
    endcase
  end
