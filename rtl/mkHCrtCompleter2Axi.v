...
//
// On Mon Apr 15 12:30:20 EDT 2013
//
...
module mkHCrtCompleter2Axi(CLK,
  ...
  // ports of submodule respBufF
  wire [39 : 0] respBufF_D_IN, respBufF_D_OUT;
  wire respBufF_CLR,
       respBufF_DEQ,
       respBufF_EMPTY_N,
       respBufF_ENQ,
  ...
  reg [63 : 0] v__h10003,
	       ...
	       v__h7645,
	       v__h9746;
  reg [3 : 0] IF_rspCRH_47_BITS_11_TO_8_06_EQ_0_07_OR_rspCRH_ETC___d212;
  ...
  reg [1 : 0] CASE_crtRespFD_OUT_BITS_19_TO_18_0_crtRespFD_ETC__q3,
	      ...
	      CASE_respBufFD_OUT_BITS_19_TO_18_0_respBufFD_ETC__q8,
	      CASE_respBufFD_OUT_BITS_29_TO_28_0_respBufFD_ETC__q7,
	      CASE_respBufFD_OUT_BITS_39_TO_38_0_respBufFD_ETC__q6,
	      CASE_respBufFD_OUT_BITS_9_TO_8_0_respBufFD_O_ETC__q9;
  wire [31 : 0] IF_rspActive_94_THEN_IF_rspAdlRemain_91_EQ_2_0_ETC___d215,
		advert__h7629,
		data__h12044;
  wire [1 : 0] IF_NOT_rspActive_94_02_OR_NOT_rspAdlRemain_91__ETC___d204,
  ...
  wire _dand2lastTag_EN_write,
       ...
       _dfoo7,
       _dfoo9,
       cmdCRH_01_BITS_3_TO_0_80_EQ_lastTag_40_BITS_3__ETC___d242,
       cmdCRH_01_BITS_3_TO_0_80_EQ_lastTag_40_BITS_3__ETC___d247;
  ...
  SizedFIFO #(.p1width(32'd40),
	      .p2depth(32'd16),
	      .p3cntr_width(32'd4),
	      .guarded(32'd1)) respBufF(.RST(RST_N),
					.CLK(CLK),
					.D_IN(respBufF_D_IN),
					.ENQ(respBufF_ENQ),
					.DEQ(respBufF_DEQ),
					.CLR(respBufF_CLR),
					.D_OUT(respBufF_D_OUT),
					.FULL_N(respBufF_FULL_N),
					.EMPTY_N(respBufF_EMPTY_N));
  ...
  assign CAN_FIRE_RL_rsp_read =
	     respBufF_FULL_N && (!rspActive || a4l_a4rdResp_fifof_EMPTY_N) &&
	     rspCRH[34:32] == 3'd5 &&
	     crtBusy ;
  assign WILL_FIRE_RL_rsp_read =
	     CAN_FIRE_RL_rsp_read && !WILL_FIRE_RL_drain_rsp_read ;
  ...
  assign CAN_FIRE_RL_drain_rsp_read =
	     crtRespF_FULL_N && respBufF_EMPTY_N && respBufTrig ;
  assign WILL_FIRE_RL_drain_rsp_read =
	     CAN_FIRE_RL_drain_rsp_read && !WILL_FIRE_RL_rsp_write &&
	     !WILL_FIRE_RL_rsp_nop ;
  ...
  assign MUX_rspCRH_write_1__SEL_1 =
	     ...
	     (!cmdCRH_01_BITS_3_TO_0_80_EQ_lastTag_40_BITS_3__ETC___d242 ||
	      !lastTag[4] ||
	      cmdCRH[7]) ;
  assign MUX_rspCRH_write_1__SEL_2 =
	     WILL_FIRE_RL_cmd_write && cmdAdlRemain == 12'd1 ;
  ...
  assign MUX_crtRespF_enq_1__VAL_1 =
	     { IF_NOT_rspActive_94_02_OR_NOT_rspAdlRemain_91__ETC___d204,
	       IF_rspActive_94_THEN_IF_rspAdlRemain_91_EQ_2_0_ETC___d215[31:24],
	       2'd0,
	       IF_rspActive_94_THEN_IF_rspAdlRemain_91_EQ_2_0_ETC___d215[23:16],
	       2'd0,
	       IF_rspActive_94_THEN_IF_rspAdlRemain_91_EQ_2_0_ETC___d215[15:8],
	       2'd0,
	       IF_rspActive_94_THEN_IF_rspAdlRemain_91_EQ_2_0_ETC___d215[7:0] } ;
  assign MUX_crtRespF_enq_1__VAL_2 =
	     { 2'd1,
	       ...
	       2'd0,
	       rspCRH[15:12],
	       IF_rspCRH_47_BITS_11_TO_8_06_EQ_0_07_OR_rspCRH_ETC___d212,
	       2'd0,
	       rspCRH[7:0] } ;
  assign MUX_crtRespF_enq_1__VAL_3 =
	     { CASE_respBufFD_OUT_BITS_39_TO_38_0_respBufFD_ETC__q6,
	       respBufF_D_OUT[37:30],
	       CASE_respBufFD_OUT_BITS_29_TO_28_0_respBufFD_ETC__q7,
	       respBufF_D_OUT[27:20],
	       CASE_respBufFD_OUT_BITS_19_TO_18_0_respBufFD_ETC__q8,
	       respBufF_D_OUT[17:10],
	       CASE_respBufFD_OUT_BITS_9_TO_8_0_respBufFD_O_ETC__q9,
	       respBufF_D_OUT[7:0] } ;
  ...
  case (1'b1)
    ...
    MUX_rspCRH_write_1__SEL_2: rspCRH_D_IN = MUX_rspCRH_write_1__VAL_2;
    MUX_cmdIsDO_write_1__SEL_3 || WILL_FIRE_RL_rsp_write ||
    MUX_cmdIsDO_write_1__SEL_5:
  ...
  assign respBufF_D_IN =
	     { IF_NOT_rspActive_94_02_OR_NOT_rspAdlRemain_91__ETC___d204,
	       ...
	       2'd0,
	       data__h12044[7:0] } ;
  assign respBufF_ENQ = WILL_FIRE_RL_rsp_read ;
  assign respBufF_DEQ = WILL_FIRE_RL_drain_rsp_read ;
  assign respBufF_CLR = 1'b0 ;

  // remaining internal signals
  assign IF_NOT_rspActive_94_02_OR_NOT_rspAdlRemain_91__ETC___d204 =
	     (!rspActive || rspAdlRemain != 12'd1) ? 2'd0 : 2'd1 ;
  assign IF_rspActive_94_THEN_IF_rspAdlRemain_91_EQ_2_0_ETC___d215 =
	     rspActive ?
	       advert__h7629 :
	       { rspCRH[31:12],
		 IF_rspCRH_47_BITS_11_TO_8_06_EQ_0_07_OR_rspCRH_ETC___d212,
  ...
  assign a4l_a4wrData_fifof_cntr_r_4_MINUS_1___d42 =
	     a4l_a4wrData_fifof_cntr_r - 2'd1 ;
  assign advert__h7629 = (rspAdlRemain == 12'd2) ? 32'h00000052 : 32'd0 ;
  assign cmdCRH_01_BITS_3_TO_0_80_EQ_lastTag_40_BITS_3__ETC___d242 =
	     cmdCRH[3:0] == lastTag[3:0] ;
  assign cmdCRH_01_BITS_3_TO_0_80_EQ_lastTag_40_BITS_3__ETC___d247 =
	     cmdCRH_01_BITS_3_TO_0_80_EQ_lastTag_40_BITS_3__ETC___d242 &&
	     lastTag[4] &&
	     !cmdCRH[7] ||
	     a4l_a4wrAddr_fifof_cntr_r != 2'd2 &&
  ...
  begin
    case (rspCRH[11:8])
	  ...
	  IF_rspCRH_47_BITS_11_TO_8_06_EQ_0_07_OR_rspCRH_ETC___d212 =
	      rspCRH[11:8];
      default: IF_rspCRH_47_BITS_11_TO_8_06_EQ_0_07_OR_rspCRH_ETC___d212 =
		   4'd15;
    endcase
  end
  ...
  always@(respBufF_D_OUT)
  begin
    case (respBufF_D_OUT[39:38])
      2'd0, 2'd1, 2'd2:
	  CASE_respBufFD_OUT_BITS_39_TO_38_0_respBufFD_ETC__q6 =
	      respBufF_D_OUT[39:38];
      2'd3: CASE_respBufFD_OUT_BITS_39_TO_38_0_respBufFD_ETC__q6 = 2'd3;
    endcase
  end
  always@(respBufF_D_OUT)
  begin
    case (respBufF_D_OUT[29:28])
      2'd0, 2'd1, 2'd2:
	  CASE_respBufFD_OUT_BITS_29_TO_28_0_respBufFD_ETC__q7 =
	      respBufF_D_OUT[29:28];
      2'd3: CASE_respBufFD_OUT_BITS_29_TO_28_0_respBufFD_ETC__q7 = 2'd3;
    endcase
  end
  always@(respBufF_D_OUT)
  begin
    case (respBufF_D_OUT[19:18])
      2'd0, 2'd1, 2'd2:
	  CASE_respBufFD_OUT_BITS_19_TO_18_0_respBufFD_ETC__q8 =
	      respBufF_D_OUT[19:18];
      2'd3: CASE_respBufFD_OUT_BITS_19_TO_18_0_respBufFD_ETC__q8 = 2'd3;
    endcase
  end
  always@(respBufF_D_OUT)
  begin
    case (respBufF_D_OUT[9:8])
      2'd0, 2'd1, 2'd2:
	  CASE_respBufFD_OUT_BITS_9_TO_8_0_respBufFD_O_ETC__q9 =
	      respBufF_D_OUT[9:8];
      2'd3: CASE_respBufFD_OUT_BITS_9_TO_8_0_respBufFD_O_ETC__q9 = 2'd3;
    endcase
  end
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rsp_write)
	$display("[%0d]: %m: Hcrt rsp_write", v__h10003);
    if (RST_N != `BSV_RESET_VALUE)
