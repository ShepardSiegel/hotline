...
//
// On Sun Feb 17 14:27:26 EST 2013
//
...
module mkHCrtCompleter2Axi(CLK,
  ...
  reg [63 : 0] v__h11364,
	       ...
	       v__h9216,
	       v__h9558;
  reg [3 : 0] IF_rspCRH_40_BITS_11_TO_8_93_EQ_0_94_OR_rspCRH_ETC___d199;
  ...
  wire [31 : 0] IF_rspActive_81_THEN_IF_rspAdlRemain_78_EQ_2_8_ETC___d202,
		advert__h6952,
		data__h11906;
  wire [1 : 0] IF_NOT_rspActive_81_89_OR_NOT_rspAdlRemain_78__ETC___d191,
  ...
  wire _dand2lastTag_EN_write,
       ...
       _dfoo7,
       _dfoo9,
       cmdAdrRemain_11_EQ_0_12_AND_cmdAdlRemain_61_EQ_ETC___d241,
       cmdCRH_03_BITS_3_TO_0_68_EQ_lastTag_16_BITS_3__ETC___d218,
       crtCmdF_i_notEmpty__02_AND_NOT_cmdAdrRemain_11_ETC___d226;
  ...
  assign MUX_cmdCRH_write_1__SEL_1 =
  ...
  assign MUX_a4l_a4wrData_fifof_q_1_write_1__VAL_1 =
	     (a4l_a4wrData_fifof_cntr_r == 2'd2) ?
	       MUX_a4l_a4wrData_fifof_q_0_write_1__VAL_2 :
	       36'd0 ;
  assign MUX_cmdAdlRemain_write_1__VAL_2 = cmdAdlRemain - 12'd1 ;
  assign MUX_cmdAdlRemain_write_1__VAL_3 =
	     (cmdAdlRemain == 12'd0) ? cmdAdlRemain - 12'd1 : cmdAdlRemain ;
  assign MUX_cmdAdrRemain_write_1__VAL_1 =
	     (cmdAdrRemain == 2'd0) ? cmdAdrRemain : cmdAdrRemain - 2'd1 ;
  assign MUX_cmdAdrRemain_write_1__VAL_2 = crtCmdF_D_OUT[6] ? 2'd2 : 2'd1 ;
  assign MUX_cmdCRH_write_1__VAL_4 =
	     { CASE_crtCmdFD_OUT_BITS_5_TO_4_0_0_1_1_2__q5, crtCmdF_D_OUT } ;
  assign MUX_crtRespF_enq_1__VAL_1 =
	     { IF_NOT_rspActive_81_89_OR_NOT_rspAdlRemain_78__ETC___d191,
	       IF_rspActive_81_THEN_IF_rspAdlRemain_78_EQ_2_8_ETC___d202[31:24],
	       2'd0,
	       IF_rspActive_81_THEN_IF_rspAdlRemain_78_EQ_2_8_ETC___d202[23:16],
	       2'd0,
	       IF_rspActive_81_THEN_IF_rspAdlRemain_78_EQ_2_8_ETC___d202[15:8],
	       2'd0,
	       IF_rspActive_81_THEN_IF_rspAdlRemain_78_EQ_2_8_ETC___d202[7:0] } ;
  assign MUX_crtRespF_enq_1__VAL_2 =
	     { 2'd1,
	       ...
	       2'd0,
	       rspCRH[15:12],
	       IF_rspCRH_40_BITS_11_TO_8_93_EQ_0_94_OR_rspCRH_ETC___d199,
	       2'd0,
	       rspCRH[7:0] } ;
  ...
  // register cmdIsLast
  assign cmdIsLast_D_IN = crtCmdF_D_OUT[31] ;
  assign cmdIsLast_EN = CAN_FIRE_RL_cmd_crh ;
  ...
  // register rspCRH
  always@(MUX_cmdCRH_write_1__SEL_1 or
	  MUX_rspCRH_write_1__VAL_1 or
	  MUX_cmdCRH_write_1__SEL_2 or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_cmdCRH_write_1__SEL_1: rspCRH_D_IN = MUX_rspCRH_write_1__VAL_1;
      MUX_cmdCRH_write_1__SEL_2: rspCRH_D_IN = MUX_rspCRH_write_1__VAL_2;
  ...
  // remaining internal signals
  assign IF_NOT_rspActive_81_89_OR_NOT_rspAdlRemain_78__ETC___d191 =
	     (!rspActive || rspAdlRemain != 12'd1) ? 2'd0 : 2'd1 ;
  assign IF_rspActive_81_THEN_IF_rspAdlRemain_78_EQ_2_8_ETC___d202 =
	     rspActive ?
	       advert__h6952 :
	       { rspCRH[31:12],
		 IF_rspCRH_40_BITS_11_TO_8_93_EQ_0_94_OR_rspCRH_ETC___d199,
  ...
  assign a4l_a4wrData_fifof_cntr_r_4_MINUS_1___d42 =
	     a4l_a4wrData_fifof_cntr_r - 2'd1 ;
  assign advert__h6952 = (rspAdlRemain == 12'd2) ? 32'h00000052 : 32'd0 ;
  assign cmdAdrRemain_11_EQ_0_12_AND_cmdAdlRemain_61_EQ_ETC___d241 =
	     cmdAdrRemain == 2'd0 && cmdAdlRemain == 12'd1 &&
	     (!cmdCRH_03_BITS_3_TO_0_68_EQ_lastTag_16_BITS_3__ETC___d218 ||
	      !lastTag[4] ||
	      cmdCRH[7]) ;
  assign cmdCRH_03_BITS_3_TO_0_68_EQ_lastTag_16_BITS_3__ETC___d218 =
	     cmdCRH[3:0] == lastTag[3:0] ;
  assign crtCmdF_i_notEmpty__02_AND_NOT_cmdAdrRemain_11_ETC___d226 =
	     crtCmdF_EMPTY_N &&
	     (cmdAdrRemain != 2'd0 || cmdAdlRemain != 12'd1 ||
	      (cmdCRH_03_BITS_3_TO_0_68_EQ_lastTag_16_BITS_3__ETC___d218 &&
	       lastTag[4] &&
  ...
  begin
    case (rspCRH[11:8])
	  ...
	  IF_rspCRH_40_BITS_11_TO_8_93_EQ_0_94_OR_rspCRH_ETC___d199 =
	      rspCRH[11:8];
      default: IF_rspCRH_40_BITS_11_TO_8_93_EQ_0_94_OR_rspCRH_ETC___d199 =
		   4'd15;
    endcase
  end
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rsp_write)
	$display("[%0d]: %m: Hcrt rsp_write", v__h9558);
    if (RST_N != `BSV_RESET_VALUE)
