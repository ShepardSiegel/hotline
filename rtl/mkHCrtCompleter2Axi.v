...
//
// On Sun Apr 14 17:13:08 EDT 2013
//
...
module mkHCrtCompleter2Axi(CLK,
  ...
  reg [63 : 0] v__h11602,
	       ...
	       v__h9379,
	       v__h9720;
  reg [3 : 0] IF_rspCRH_45_BITS_11_TO_8_01_EQ_0_02_OR_rspCRH_ETC___d207;
  ...
  wire [31 : 0] IF_rspActive_89_THEN_IF_rspAdlRemain_86_EQ_2_9_ETC___d210,
		advert__h7064,
		data__h12143;
  wire [11 : 0] cmdAdlRemain_66_MINUS_1___d168;
  wire [1 : 0] IF_NOT_rspActive_89_97_OR_NOT_rspAdlRemain_86__ETC___d199,
  ...
  wire _dand2lastTag_EN_write,
       ...
       _dfoo7,
       _dfoo9,
       cmdAdrRemain_19_EQ_0_20_AND_cmdAdlRemain_66_EQ_ETC___d249,
       cmdCRH_01_BITS_3_TO_0_75_EQ_lastTag_24_BITS_3__ETC___d226,
       crtCmdF_i_notEmpty__00_AND_NOT_cmdAdrRemain_19_ETC___d234;
  ...
  assign MUX_cmdAdlRemain_write_1__VAL_2 =
	     (cmdAdlRemain == 12'd0) ?
	       cmdAdlRemain :
	       cmdAdlRemain_66_MINUS_1___d168 ;
  ...
  assign MUX_crtRespF_enq_1__VAL_1 =
	     { IF_NOT_rspActive_89_97_OR_NOT_rspAdlRemain_86__ETC___d199,
	       IF_rspActive_89_THEN_IF_rspAdlRemain_86_EQ_2_9_ETC___d210[31:24],
	       2'd0,
	       IF_rspActive_89_THEN_IF_rspAdlRemain_86_EQ_2_9_ETC___d210[23:16],
	       2'd0,
	       IF_rspActive_89_THEN_IF_rspAdlRemain_86_EQ_2_9_ETC___d210[15:8],
	       2'd0,
	       IF_rspActive_89_THEN_IF_rspAdlRemain_86_EQ_2_9_ETC___d210[7:0] } ;
  assign MUX_crtRespF_enq_1__VAL_2 =
	     { 2'd1,
	       ...
	       2'd0,
	       rspCRH[15:12],
	       IF_rspCRH_45_BITS_11_TO_8_01_EQ_0_02_OR_rspCRH_ETC___d207,
	       2'd0,
	       rspCRH[7:0] } ;
  ...
  assign cmdIsLast_D_IN =
	     MUX_cmdAdrRemain_write_1__SEL_1 && crtCmdF_D_OUT[31] ;
  assign cmdIsLast_EN =
	     WILL_FIRE_RL_cmd_crh && crtCmdF_D_OUT != 32'd0 ||
	     (WILL_FIRE_RL_rsp_read || WILL_FIRE_RL_rsp_nop) && rspActive &&
	     rspAdlRemain == 12'd1 ||
  ...
  // remaining internal signals
  assign IF_NOT_rspActive_89_97_OR_NOT_rspAdlRemain_86__ETC___d199 =
	     (!rspActive || rspAdlRemain != 12'd1) ? 2'd0 : 2'd1 ;
  assign IF_rspActive_89_THEN_IF_rspAdlRemain_86_EQ_2_9_ETC___d210 =
	     rspActive ?
	       advert__h7064 :
	       { rspCRH[31:12],
		 IF_rspCRH_45_BITS_11_TO_8_01_EQ_0_02_OR_rspCRH_ETC___d207,
  ...
  assign a4l_a4wrData_fifof_cntr_r_4_MINUS_1___d42 =
	     a4l_a4wrData_fifof_cntr_r - 2'd1 ;
  assign advert__h7064 = (rspAdlRemain == 12'd2) ? 32'h00000052 : 32'd0 ;
  assign cmdAdlRemain_66_MINUS_1___d168 = cmdAdlRemain - 12'd1 ;
  assign cmdAdrRemain_19_EQ_0_20_AND_cmdAdlRemain_66_EQ_ETC___d249 =
	     cmdAdrRemain == 2'd0 && cmdAdlRemain == 12'd1 &&
	     (!cmdCRH_01_BITS_3_TO_0_75_EQ_lastTag_24_BITS_3__ETC___d226 ||
	      !lastTag[4] ||
	      cmdCRH[7]) ;
  assign cmdCRH_01_BITS_3_TO_0_75_EQ_lastTag_24_BITS_3__ETC___d226 =
	     cmdCRH[3:0] == lastTag[3:0] ;
  assign crtCmdF_i_notEmpty__00_AND_NOT_cmdAdrRemain_19_ETC___d234 =
	     crtCmdF_EMPTY_N &&
	     (cmdAdrRemain != 2'd0 || cmdAdlRemain != 12'd1 ||
	      (cmdCRH_01_BITS_3_TO_0_75_EQ_lastTag_24_BITS_3__ETC___d226 &&
	       lastTag[4] &&
  ...
  begin
    case (rspCRH[11:8])
	  ...
	  IF_rspCRH_45_BITS_11_TO_8_01_EQ_0_02_OR_rspCRH_ETC___d207 =
	      rspCRH[11:8];
      default: IF_rspCRH_45_BITS_11_TO_8_01_EQ_0_02_OR_rspCRH_ETC___d207 =
		   4'd15;
    endcase
  end
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rsp_write)
	$display("[%0d]: %m: Hcrt rsp_write", v__h9720);
    if (RST_N != `BSV_RESET_VALUE)
