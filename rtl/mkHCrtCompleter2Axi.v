...
//
// On Mon Apr 15 15:26:42 EDT 2013
//
...
module mkHCrtCompleter2Axi(CLK,
  ...
  wire _dand2lastTag_EN_write,
       ...
       _dfoo7,
       _dfoo9,
       cmdCRH_01_BITS_3_TO_0_80_EQ_lastTag_42_BITS_3__ETC___d244,
       cmdCRH_01_BITS_3_TO_0_80_EQ_lastTag_42_BITS_3__ETC___d249;
  ...
  assign a4l_a4wrData_fifof_cntr_r_4_MINUS_1___d42 =
	     a4l_a4wrData_fifof_cntr_r - 2'd1 ;
  assign advert__h7710 = (rspAdlRemain == 12'd2) ? 32'h00000052 : 32'd0 ;
  assign cmdCRH_01_BITS_3_TO_0_80_EQ_lastTag_42_BITS_3__ETC___d244 =
	     cmdCRH[3:0] == lastTag[3:0] ;
  assign cmdCRH_01_BITS_3_TO_0_80_EQ_lastTag_42_BITS_3__ETC___d249 =
	     cmdCRH_01_BITS_3_TO_0_80_EQ_lastTag_42_BITS_3__ETC___d244 &&
	     lastTag[4] &&
	     !cmdCRH[7] ||
	     a4l_a4wrAddr_fifof_cntr_r != 2'd2 &&
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rsp_write)
	$display("[%0d]: %m: Hcrt rsp_write", v__h10163);
    if (RST_N != `BSV_RESET_VALUE)
