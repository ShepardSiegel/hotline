...
//
// On Fri Mar  1 14:52:24 EST 2013
//
// Method conflict info:
// Method: axi_mAWVALID
// Conflict-free: axi_mAWVALID,
// 	       axi_sAWREADY,
// 	       axi_mAWADDR,
// 	       axi_mAWPROT,
// 	       axi_mWVALID,
...
module mkL2HCrt(sys0_clk,
  ...
  // value method axi_mAWVALID
  output axi_AWVALID;

  // action method axi_sAWREADY
  input  axi_AWREADY;

  // value method axi_mAWADDR
  output [31 : 0] axi_AWADDR;

  // value method axi_mAWPROT
  output [2 : 0] axi_AWPROT;

  // value method axi_mWVALID
  output axi_WVALID;

  // action method axi_sWREADY
  input  axi_WREADY;

  // value method axi_mWDATA
  output [31 : 0] axi_WDATA;

  // value method axi_mWSTRB
  output [3 : 0] axi_WSTRB;

  // action method axi_sBVALID
  input  axi_BVALID;

  // value method axi_mBREADY
  output axi_BREADY;

  // action method axi_sBRESP
  input  [1 : 0] axi_BRESP;

  // value method axi_mARVALID
  output axi_ARVALID;

  // action method axi_sARREADY
  input  axi_ARREADY;

  // value method axi_mARADDR
  output [31 : 0] axi_ARADDR;

  // value method axi_mARPROT
  output [2 : 0] axi_ARPROT;

  // action method axi_sRVALID
  input  axi_RVALID;

  // value method axi_mRREADY
  output axi_RREADY;

  // action method axi_sRDATA
  input  [31 : 0] axi_RDATA;

  // action method axi_sRRESP
  input  [1 : 0] axi_RRESP;
  ...
  // oscillator and gates for output clock e125Clk
  output e125Clk;
  output CLK_GATE_e125Clk;
  ...
  wire [3 : 0] axi_WSTRB;
  wire [2 : 0] axi_ARPROT, axi_AWPROT;
  wire CLK_GATE_e125Clk,
       CLK_GATE_gmii_tx_tx_clk,
       CLK_GATE_rxclkBnd,
       axi_ARVALID,
       axi_AWVALID,
  ...
  wire CAN_FIRE_RL_a4lm_doAlways,
       ...
       CAN_FIRE_axi_sARREADY,
       CAN_FIRE_axi_sAWREADY,
       CAN_FIRE_axi_sBRESP,
       CAN_FIRE_axi_sBVALID,
       CAN_FIRE_axi_sRDATA,
       CAN_FIRE_axi_sRRESP,
       CAN_FIRE_axi_sRVALID,
       CAN_FIRE_axi_sWREADY,
       CAN_FIRE_gmii_col,
       CAN_FIRE_gmii_crs,
       CAN_FIRE_gmii_intr,
       ...
       WILL_FIRE_axi_sARREADY,
       WILL_FIRE_axi_sAWREADY,
       WILL_FIRE_axi_sBRESP,
       WILL_FIRE_axi_sBVALID,
       WILL_FIRE_axi_sRDATA,
       WILL_FIRE_axi_sRRESP,
       WILL_FIRE_axi_sRVALID,
       WILL_FIRE_axi_sWREADY,
       WILL_FIRE_gmii_col,
       WILL_FIRE_gmii_crs,
       WILL_FIRE_gmii_intr,
  ...
  // oscillator and gates for output clock e125Clk
  assign e125Clk = sys1_clk_O ;
  assign CLK_GATE_e125Clk = 1'b1 ;
  ...
  // value method axi_mAWVALID
  assign axi_AWVALID = crt2axi_axiM0_wrAddr_valid ;

  // action method axi_sAWREADY
  assign CAN_FIRE_axi_sAWREADY = 1'd1 ;
  assign WILL_FIRE_axi_sAWREADY = axi_AWREADY ;

  // value method axi_mAWADDR
  assign axi_AWADDR = crt2axi_axiM0_wrAddr_data[31:0] ;

  // value method axi_mAWPROT
  assign axi_AWPROT = crt2axi_axiM0_wrAddr_data[34:32] ;

  // value method axi_mWVALID
  assign axi_WVALID = crt2axi_axiM0_wrData_valid ;

  // action method axi_sWREADY
  assign CAN_FIRE_axi_sWREADY = 1'd1 ;
  assign WILL_FIRE_axi_sWREADY = axi_WREADY ;

  // value method axi_mWDATA
  assign axi_WDATA = crt2axi_axiM0_wrData_data[31:0] ;

  // value method axi_mWSTRB
  assign axi_WSTRB = crt2axi_axiM0_wrData_data[35:32] ;

  // action method axi_sBVALID
  assign CAN_FIRE_axi_sBVALID = 1'd1 ;
  assign WILL_FIRE_axi_sBVALID = axi_BVALID ;

  // value method axi_mBREADY
  assign axi_BREADY = crt2axi_axiM0_wrResp_ready ;

  // action method axi_sBRESP
  assign CAN_FIRE_axi_sBRESP = 1'd1 ;
  assign WILL_FIRE_axi_sBRESP = 1'd1 ;

  // value method axi_mARVALID
  assign axi_ARVALID = crt2axi_axiM0_rdAddr_valid ;

  // action method axi_sARREADY
  assign CAN_FIRE_axi_sARREADY = 1'd1 ;
  assign WILL_FIRE_axi_sARREADY = axi_ARREADY ;

  // value method axi_mARADDR
  assign axi_ARADDR = crt2axi_axiM0_rdAddr_data[31:0] ;

  // value method axi_mARPROT
  assign axi_ARPROT = crt2axi_axiM0_rdAddr_data[34:32] ;

  // action method axi_sRVALID
  assign CAN_FIRE_axi_sRVALID = 1'd1 ;
  assign WILL_FIRE_axi_sRVALID = axi_RVALID ;

  // value method axi_mRREADY
  assign axi_RREADY = crt2axi_axiM0_rdResp_ready ;

  // action method axi_sRDATA
  assign CAN_FIRE_axi_sRDATA = 1'd1 ;
  assign WILL_FIRE_axi_sRDATA = 1'd1 ;

  // action method axi_sRRESP
  assign CAN_FIRE_axi_sRRESP = 1'd1 ;
  assign WILL_FIRE_axi_sRRESP = 1'd1 ;
  ...
  // submodule crt2axi
  assign crt2axi_axiM0_rdAddr_ready_value = axi_ARREADY ;
  assign crt2axi_axiM0_rdResp_data_value = { axi_RRESP, axi_RDATA } ;
  assign crt2axi_axiM0_rdResp_valid_value = axi_RVALID ;
  assign crt2axi_axiM0_wrAddr_ready_value = axi_AWREADY ;
  assign crt2axi_axiM0_wrData_ready_value = axi_WREADY ;
  assign crt2axi_axiM0_wrResp_data_value = axi_BRESP ;
  assign crt2axi_axiM0_wrResp_valid_value = axi_BVALID ;
