...
//
// On Thu Feb 28 17:16:15 EST 2013
//
...
module mkFTop_kc705(sys0_clk,
  ...
  reg [1 : 0] CASE_crt2axicrtS0_response_get_BITS_19_TO_18__ETC__q8,
	      CASE_crt2axicrtS0_response_get_BITS_29_TO_28__ETC__q7,
	      CASE_crt2axicrtS0_response_get_BITS_39_TO_38__ETC__q6,
	      CASE_crt2axicrtS0_response_get_BITS_9_TO_8_0__ETC__q9,
	      CASE_gmacrx_get_BITS_9_TO_8_0_gmacrx_get_BIT_ETC__q3,
	      CASE_l2Pclient_request_get_BITS_9_TO_8_0_l2P_ETC__q4,
	      CASE_l2Pserver_response_get_BITS_9_TO_8_0_l2P_ETC__q1,
	      CASE_l2qc_inFD_OUT_BITS_9_TO_8_0_l2qc_inFD_O_ETC__q11,
	      CASE_l2qc_sr_BITS_19_TO_18_0_l2qc_sr_BITS_19_T_ETC__q13,
	      CASE_l2qc_sr_BITS_29_TO_28_0_l2qc_sr_BITS_29_T_ETC__q14,
	      CASE_l2qc_sr_BITS_9_TO_8_0_l2qc_sr_BITS_9_TO_8_ETC__q12,
	      CASE_qcl2_outFD_OUT_BITS_9_TO_8_0_qcl2_outFD_ETC__q2;
  reg CASE_qcl2_ptr_0_qcl2_inFD_OUT_BITS_9_TO_8_EQ__ETC__q16,
      CASE_qcl2_ptr_0_qcl2_inFD_OUT_BITS_9_TO_8_EQ__ETC__q17,
  ...
  wire [194 : 0] _1434766110945527031733894725304609466537681244_ETC__q5,
		 ...
		 bs__h21756,
		 bs__h34515;
  wire [116 : 0] _130549178157447095380771276656813203__q21,
		 _166153498389916941667817601160445959__q19,
		 _306783360__q15,
		 wRdData__h1748;
  wire [86 : 0] _121583396715528419856163987__q20,
		_154742503901866210315206599__q18,
		wWrData__h1752;
  wire [31 : 0] v__h51390;
  ...
  assign MUX_i2cC_rOutEn_write_1__VAL_1 =
	     _154742503901866210315206599__q18[i2cC_rPlayIndex_Q_OUT[6:0]] ;
  assign MUX_i2cC_rOutEn_write_1__VAL_2 =
	     _166153498389916941667817601160445959__q19[i2cC_rPlayIndex_Q_OUT[6:0]] ;
  assign MUX_i2cC_rSCL_write_1__VAL_1 =
	     _121583396715528419856163987__q20[i2cC_rPlayIndex_Q_OUT[6:0]] ;
  assign MUX_i2cC_rSCL_write_1__VAL_2 =
	     _130549178157447095380771276656813203__q21[i2cC_rPlayIndex_Q_OUT[6:0]] ;
  ...
  assign mdi_vrReadData_0_EN =
	     WILL_FIRE_RL_mdi_run_frame && mdi_rPlayIndex_Q_OUT != 8'd0 &&
	     !mdi_rWrite &&
	     _643371375338640__q10[mdi_rPlayIndex_Q_OUT] ;
  ...
  assign qcl2_inF_D_IN =
	     { CASE_crt2axicrtS0_response_get_BITS_39_TO_38__ETC__q6,
	       ...
	       CASE_crt2axicrtS0_response_get_BITS_19_TO_18__ETC__q8,
  ...
  assign IF_SEL_ARR_qcl2_inF_first__58_BITS_9_TO_8_59_E_ETC___d393 =
	     { CASE_qcl2_ptr_0_qcl2_inFD_OUT_BITS_9_TO_8_EQ__ETC__q16 ?
		 2'd2 :
		 2'd3,
	       SEL_ARR_qcl2_inF_first__58_BITS_7_TO_0_72_qcl2_ETC___d377 } ;
  ...
  assign IF_l2qc_sr_06_BITS_9_TO_8_18_EQ_0_19_OR_l2qc_s_ETC___d328 =
	     { CASE_l2qc_sr_BITS_9_TO_8_0_l2qc_sr_BITS_9_TO_8_ETC__q12,
	       l2qc_sr[7:0] } ;
  assign _121583396715528419856163987__q20 = 87'h6492492492492492492493 ;
  assign _130549178157447095380771276656813203__q21 =
  ...
  assign _154742503901866210315206599__q18 = 87'h7FFFFFF1FFFFFE3FFFFFC7 ;
  assign _166153498389916941667817601160445959__q19 =
	     117'h1FFFFFFC7FFFFF8FFFFFFE00000007 ;
  assign _306783360_BIT_i2cC_rPlayIndex_value__8_BITS_6__ETC___d108 =
	     _306783360__q15[i2cC_rPlayIndex_Q_OUT[6:0]] ;
  assign _306783360__q15 = 117'd306783360 ;
  ...
  begin
    case (l2P_server_response_get[9:8])
      ...
      2'd3: CASE_l2Pserver_response_get_BITS_9_TO_8_0_l2P_ETC__q1 = 2'd3;
    endcase
  end
  ...
  begin
    case (gmac_rx_get[9:8])
	  ...
	  CASE_gmacrx_get_BITS_9_TO_8_0_gmacrx_get_BIT_ETC__q3 =
	      gmac_rx_get[9:8];
      2'd3: CASE_gmacrx_get_BITS_9_TO_8_0_gmacrx_get_BIT_ETC__q3 = 2'd3;
    endcase
  end
  ...
  begin
    case (l2P_client_request_get[9:8])
      ...
      2'd3: CASE_l2Pclient_request_get_BITS_9_TO_8_0_l2P_ETC__q4 = 2'd3;
    endcase
  end
  ...
  begin
    case (crt2axi_crtS0_response_get[39:38])
      ...
      2'd3: CASE_crt2axicrtS0_response_get_BITS_39_TO_38__ETC__q6 = 2'd3;
    endcase
  end
  always@(crt2axi_crtS0_response_get)
  begin
    case (crt2axi_crtS0_response_get[29:28])
      ...
      2'd3: CASE_crt2axicrtS0_response_get_BITS_29_TO_28__ETC__q7 = 2'd3;
    endcase
  end
  always@(crt2axi_crtS0_response_get)
  begin
    case (crt2axi_crtS0_response_get[19:18])
      ...
      2'd3: CASE_crt2axicrtS0_response_get_BITS_19_TO_18__ETC__q8 = 2'd3;
    endcase
  end
  always@(crt2axi_crtS0_response_get)
  begin
    case (crt2axi_crtS0_response_get[9:8])
      ...
      2'd3: CASE_crt2axicrtS0_response_get_BITS_9_TO_8_0__ETC__q9 = 2'd3;
    endcase
  end
  ...
  begin
    case (l2qc_inF_D_OUT[9:8])
	  ...
	  CASE_l2qc_inFD_OUT_BITS_9_TO_8_0_l2qc_inFD_O_ETC__q11 =
	      l2qc_inF_D_OUT[9:8];
      2'd3: CASE_l2qc_inFD_OUT_BITS_9_TO_8_0_l2qc_inFD_O_ETC__q11 = 2'd3;
    endcase
  end
  always@(l2qc_sr)
  begin
    case (l2qc_sr[9:8])
	  ...
	  CASE_l2qc_sr_BITS_9_TO_8_0_l2qc_sr_BITS_9_TO_8_ETC__q12 =
	      l2qc_sr[9:8];
      2'd3: CASE_l2qc_sr_BITS_9_TO_8_0_l2qc_sr_BITS_9_TO_8_ETC__q12 = 2'd3;
    endcase
  end
  always@(l2qc_sr)
  begin
  ...
  begin
    case (l2qc_sr[29:28])
	  ...
	  CASE_l2qc_sr_BITS_29_TO_28_0_l2qc_sr_BITS_29_T_ETC__q14 =
	      l2qc_sr[29:28];
      2'd3: CASE_l2qc_sr_BITS_29_TO_28_0_l2qc_sr_BITS_29_T_ETC__q14 = 2'd3;
    endcase
  end
  always@(qcl2_ptr or qcl2_inF_D_OUT)
  begin
