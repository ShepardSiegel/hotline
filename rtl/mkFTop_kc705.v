...
//
// On Mon Feb 18 16:35:48 EST 2013
//
...
module mkFTop_kc705(sys0_clk,
  ...
  reg [1 : 0] CASE_crt2axicrtS0_response_get_BITS_19_TO_18__ETC__q6,
	      ...
	      CASE_gmacrx_get_BITS_9_TO_8_0_gmacrx_get_BIT_ETC__q2,
	      CASE_l2Pclient_request_get_BITS_9_TO_8_0_l2P_ETC__q3,
	      CASE_l2Pserver_response_get_BITS_9_TO_8_0_l2P_ETC__q19,
	      CASE_l2qc_inFD_OUT_BITS_9_TO_8_0_l2qc_inFD_O_ETC__q9,
	      CASE_l2qc_sr_BITS_19_TO_18_0_l2qc_sr_BITS_19_T_ETC__q11,
	      CASE_l2qc_sr_BITS_29_TO_28_0_l2qc_sr_BITS_29_T_ETC__q12,
	      CASE_l2qc_sr_BITS_9_TO_8_0_l2qc_sr_BITS_9_TO_8_ETC__q8,
	      CASE_qcl2_outFD_OUT_BITS_9_TO_8_0_qcl2_outFD_ETC__q1;
  ...
  assign lcd_ctrl_setLine2_text = 128'h747365542054524320656E696C746F48 ;
  ...
  assign _306783360_BIT_i2cC_rPlayIndex_value__8_BITS_6__ETC___d108 =
	     _306783360__q10[i2cC_rPlayIndex_Q_OUT[6:0]] ;
  assign _306783360__q10 = 117'd306783360 ;
  ...
  begin
    case (qcl2_outF_D_OUT[9:8])
	  ...
	  CASE_qcl2_outFD_OUT_BITS_9_TO_8_0_qcl2_outFD_ETC__q1 =
	      qcl2_outF_D_OUT[9:8];
      2'd3: CASE_qcl2_outFD_OUT_BITS_9_TO_8_0_qcl2_outFD_ETC__q1 = 2'd3;
    endcase
  end
  always@(gmac_rx_get)
  begin
    case (gmac_rx_get[9:8])
	  ...
	  CASE_gmacrx_get_BITS_9_TO_8_0_gmacrx_get_BIT_ETC__q2 =
	      gmac_rx_get[9:8];
      2'd3: CASE_gmacrx_get_BITS_9_TO_8_0_gmacrx_get_BIT_ETC__q2 = 2'd3;
    endcase
  end
  ...
  begin
    case (l2qc_sr[9:8])
	  ...
	  CASE_l2qc_sr_BITS_9_TO_8_0_l2qc_sr_BITS_9_TO_8_ETC__q8 =
	      l2qc_sr[9:8];
      2'd3: CASE_l2qc_sr_BITS_9_TO_8_0_l2qc_sr_BITS_9_TO_8_ETC__q8 = 2'd3;
    endcase
  end
  ...
  begin
    case (l2qc_inF_D_OUT[9:8])
	  ...
	  CASE_l2qc_inFD_OUT_BITS_9_TO_8_0_l2qc_inFD_O_ETC__q9 =
	      l2qc_inF_D_OUT[9:8];
      2'd3: CASE_l2qc_inFD_OUT_BITS_9_TO_8_0_l2qc_inFD_O_ETC__q9 = 2'd3;
    endcase
  end
  always@(qcl2_ptr or qcl2_inF_D_OUT)
  begin
  ...
  begin
    case (l2qc_sr[19:18])
	  ...
	  CASE_l2qc_sr_BITS_19_TO_18_0_l2qc_sr_BITS_19_T_ETC__q11 =
	      l2qc_sr[19:18];
      2'd3: CASE_l2qc_sr_BITS_19_TO_18_0_l2qc_sr_BITS_19_T_ETC__q11 = 2'd3;
    endcase
  end
  always@(l2qc_sr)
  begin
