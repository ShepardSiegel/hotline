...
//
// On Fri Mar  1 14:53:06 EST 2013
//
...
module mkFTop_kc705(sys0_clk,
		    ...
		    .mdio_mdd(l2hcrt_mdio_mdd),
		    .mdio_mdc(l2hcrt_mdio_mdc),
  ...
  inout  i2cC_tSDA_IO;
  inout  i2cC_tSCL_IO;
  inout  l2hcrt_mdio_mdd;
  inout  l2hcrt_mdio_mdc;
  ...
  wire [31 : 0] l2hcrt_axi_ARADDR,
		l2hcrt_axi_AWADDR,
		l2hcrt_axi_RDATA,
		l2hcrt_axi_WDATA;
  wire [7 : 0] l2hcrt_gmii_rx_rxd_i, l2hcrt_gmii_tx_txd;
  wire [3 : 0] l2hcrt_axi_WSTRB;
  wire [2 : 0] l2hcrt_axi_ARPROT, l2hcrt_axi_AWPROT;
  wire [1 : 0] l2hcrt_axi_BRESP, l2hcrt_axi_RRESP;
  wire l2hcrt_axi_ARREADY,
       l2hcrt_axi_ARVALID,
       l2hcrt_axi_AWREADY,
       l2hcrt_axi_AWVALID,
       l2hcrt_axi_BREADY,
       ...
       l2hcrt_gmii_led,
       l2hcrt_gmii_rstn,
       l2hcrt_gmii_rx_rx_dv_i,
       l2hcrt_gmii_rx_rx_er_i,
       l2hcrt_gmii_tx_tx_clk,
       l2hcrt_gmii_tx_tx_en,
       l2hcrt_gmii_tx_tx_er,
       l2hcrt_mdio_mdc,
       l2hcrt_mdio_mdd,
       l2hcrt_rxclkBnd;
  ...
  // oscillator and gates for output clock rxclkBnd
  assign rxclkBnd = l2hcrt_rxclkBnd ;
  assign CLK_GATE_rxclkBnd = 1'b1 ;

  // oscillator and gates for output clock gmii_tx_tx_clk
  assign gmii_tx_tx_clk = l2hcrt_gmii_tx_tx_clk ;
  ...
  // value method gmii_tx_txd
  assign gmii_tx_txd = l2hcrt_gmii_tx_txd ;

  // value method gmii_tx_tx_en
  assign gmii_tx_tx_en = l2hcrt_gmii_tx_tx_en ;

  // value method gmii_tx_tx_er
  assign gmii_tx_tx_er = l2hcrt_gmii_tx_tx_er ;
  ...
  // submodule a4ls
  mkA4LS #(.hasDebugLogic(1'd1)) a4ls(.ACLK(l2hcrt_e125Clk),
				      .ARESETN(l2hcrt_gmii_rstn),
				      .ARADDR(a4ls_ARADDR),
				      .ARPROT(a4ls_ARPROT),
				      .AWADDR(a4ls_AWADDR),
				      .AWPROT(a4ls_AWPROT),
  ...
  mkL2HCrt l2hcrt(.sys0_clk(sys0_clk),
		  ...
		  .axi_BRESP(l2hcrt_axi_BRESP),
		  .axi_RDATA(l2hcrt_axi_RDATA),
		  .axi_RRESP(l2hcrt_axi_RRESP),
		  .gmii_col_i(l2hcrt_gmii_col_i),
		  .gmii_crs_i(l2hcrt_gmii_crs_i),
		  .gmii_intr_i(l2hcrt_gmii_intr_i),
		  .gmii_rx_rx_dv_i(l2hcrt_gmii_rx_rx_dv_i),
		  .gmii_rx_rx_er_i(l2hcrt_gmii_rx_rx_er_i),
		  .gmii_rx_rxd_i(l2hcrt_gmii_rx_rxd_i),
		  .axi_AWREADY(l2hcrt_axi_AWREADY),
		  .axi_WREADY(l2hcrt_axi_WREADY),
		  .axi_BVALID(l2hcrt_axi_BVALID),
		  .axi_ARREADY(l2hcrt_axi_ARREADY),
		  .axi_RVALID(l2hcrt_axi_RVALID),
		  .axi_AWVALID(l2hcrt_axi_AWVALID),
		  .axi_AWADDR(l2hcrt_axi_AWADDR),
		  .axi_AWPROT(l2hcrt_axi_AWPROT),
		  .axi_WVALID(l2hcrt_axi_WVALID),
		  .axi_WDATA(l2hcrt_axi_WDATA),
		  .axi_WSTRB(l2hcrt_axi_WSTRB),
		  .axi_BREADY(l2hcrt_axi_BREADY),
		  .axi_ARVALID(l2hcrt_axi_ARVALID),
		  .axi_ARADDR(l2hcrt_axi_ARADDR),
		  .axi_ARPROT(l2hcrt_axi_ARPROT),
		  .axi_RREADY(l2hcrt_axi_RREADY),
		  .gmii_tx_txd(l2hcrt_gmii_tx_txd),
		  .gmii_tx_tx_en(l2hcrt_gmii_tx_tx_en),
		  .gmii_tx_tx_er(l2hcrt_gmii_tx_tx_er),
		  .gmii_led(l2hcrt_gmii_led),
		  .e125Clk(l2hcrt_e125Clk),
		  .CLK_GATE_e125Clk(),
		  .rxclkBnd(l2hcrt_rxclkBnd),
		  .CLK_GATE_rxclkBnd(),
		  .gmii_tx_tx_clk(l2hcrt_gmii_tx_tx_clk),
		  .CLK_GATE_gmii_tx_tx_clk(),
  ...
  // submodule a4ls
  assign a4ls_ARADDR = l2hcrt_axi_ARADDR ;
  assign a4ls_ARPROT = l2hcrt_axi_ARPROT ;
  assign a4ls_AWADDR = l2hcrt_axi_AWADDR ;
  assign a4ls_AWPROT = l2hcrt_axi_AWPROT ;
  assign a4ls_WDATA = l2hcrt_axi_WDATA ;
  assign a4ls_WSTRB = l2hcrt_axi_WSTRB ;
  assign a4ls_AWVALID = l2hcrt_axi_AWVALID ;
  assign a4ls_WVALID = l2hcrt_axi_WVALID ;
  assign a4ls_BREADY = l2hcrt_axi_BREADY ;
  assign a4ls_ARVALID = l2hcrt_axi_ARVALID ;
  assign a4ls_RREADY = l2hcrt_axi_RREADY ;

  // submodule i2cC_fRequest
  assign i2cC_fRequest_D_IN = { 1'd1, v__h22509[23:17], v__h22509[15:0] } ;
  ...
  // submodule l2hcrt
  assign l2hcrt_axi_BRESP = a4ls_BRESP ;
  assign l2hcrt_axi_RDATA = a4ls_RDATA ;
  assign l2hcrt_axi_RRESP = a4ls_RRESP ;
  assign l2hcrt_gmii_col_i = gmii_col_i ;
  assign l2hcrt_gmii_crs_i = gmii_crs_i ;
  assign l2hcrt_gmii_intr_i = gmii_intr_i ;
  assign l2hcrt_gmii_rx_rx_dv_i = gmii_rx_rx_dv_i ;
  assign l2hcrt_gmii_rx_rx_er_i = gmii_rx_rx_er_i ;
  assign l2hcrt_gmii_rx_rxd_i = gmii_rx_rxd_i ;
  assign l2hcrt_axi_AWREADY = a4ls_AWREADY ;
  assign l2hcrt_axi_WREADY = a4ls_WREADY ;
  assign l2hcrt_axi_BVALID = a4ls_BVALID ;
  assign l2hcrt_axi_ARREADY = a4ls_ARREADY ;
  assign l2hcrt_axi_RVALID = a4ls_RVALID ;

  // submodule lcd_ctrl
  assign lcd_ctrl_setLine1_text = 128'h434C4C2073656C75522063696D6F7441 ;
  assign lcd_ctrl_setLine2_text = 128'h6131302E33302E333130322054524348 ;
