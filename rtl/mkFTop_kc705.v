...
//
// On Sun Feb 17 14:28:40 EST 2013
//
...
module mkFTop_kc705(sys0_clk,
  ...
  wire [7 : 0] i2cC_fResponse_D_IN, i2cC_fResponse_D_OUT;
  wire i2cC_fResponse_CLR,
       i2cC_fResponse_DEQ,
       i2cC_fResponse_EMPTY_N,
       i2cC_fResponse_ENQ,
  ...
  wire CAN_FIRE_RL_a4lm_doAlways,
       ...
       CAN_FIRE_RL_read_iiceeprom_req,
       CAN_FIRE_RL_read_iiceeprom_resp,
       ...
       WILL_FIRE_RL_read_iiceeprom_req,
       WILL_FIRE_RL_read_iiceeprom_resp,
  ...
  wire [23 : 0] MUX_i2cC_fRequest_enq_1__VAL_1,
		MUX_i2cC_fRequest_enq_1__VAL_2;
  ...
  reg [1 : 0] CASE_crt2axicrtS0_response_get_BITS_19_TO_18__ETC__q19,
	      CASE_crt2axicrtS0_response_get_BITS_29_TO_28__ETC__q18,
	      CASE_crt2axicrtS0_response_get_BITS_39_TO_38__ETC__q17,
	      CASE_crt2axicrtS0_response_get_BITS_9_TO_8_0__ETC__q20,
	      CASE_gmacrx_get_BITS_9_TO_8_0_gmacrx_get_BIT_ETC__q13,
	      CASE_l2Pclient_request_get_BITS_9_TO_8_0_l2P_ETC__q14,
	      CASE_l2Pserver_response_get_BITS_9_TO_8_0_l2P_ETC__q11,
	      CASE_l2qc_inFD_OUT_BITS_9_TO_8_0_l2qc_inFD_O_ETC__q1,
	      CASE_l2qc_sr_BITS_19_TO_18_0_l2qc_sr_BITS_19_T_ETC__q3,
	      CASE_l2qc_sr_BITS_29_TO_28_0_l2qc_sr_BITS_29_T_ETC__q15,
	      CASE_l2qc_sr_BITS_9_TO_8_0_l2qc_sr_BITS_9_TO_8_ETC__q2,
	      CASE_qcl2_outFD_OUT_BITS_9_TO_8_0_qcl2_outFD_ETC__q12;
  reg CASE_qcl2_ptr_0_qcl2_inFD_OUT_BITS_9_TO_8_EQ__ETC__q5,
      CASE_qcl2_ptr_0_qcl2_inFD_OUT_BITS_9_TO_8_EQ__ETC__q6,
      SEL_ARR_qcl2_inF_first__58_BITS_9_TO_8_59_EQ_0_ETC___d369;
  wire [194 : 0] _1434766110945527031733894725304609466537681244_ETC__q16,
		 _643371375338640__q21,
		 bs__h21762,
		 bs__h34521;
  wire [116 : 0] _130549178157447095380771276656813203__q10,
		 _166153498389916941667817601160445959__q8,
		 _306783360__q4,
		 wRdData__h1755;
  wire [86 : 0] _121583396715528419856163987__q9,
		_154742503901866210315206599__q7,
		wWrData__h1759;
  wire [31 : 0] v__h52775;
  wire [15 : 0] x_data__h37798;
  ...
  SizedFIFO #(.p1width(32'd8),
	      ...
	      .guarded(32'd1)) i2cC_fResponse(.RST(sys0_rst_OUT_RST),
					      ...
					      .D_OUT(i2cC_fResponse_D_OUT),
					      .FULL_N(i2cC_fResponse_FULL_N),
					      .EMPTY_N(i2cC_fResponse_EMPTY_N));
  ...
  // rule RL_read_iiceeprom_req
  assign CAN_FIRE_RL_read_iiceeprom_req =
	     i2cC_fRequest_FULL_N && macAddrCnt < 11'd1023 && !macAddrRead ;
  assign WILL_FIRE_RL_read_iiceeprom_req = CAN_FIRE_RL_read_iiceeprom_req ;

  // rule RL_assign_mac
  assign CAN_FIRE_RL_assign_mac = 1'd1 ;
  assign WILL_FIRE_RL_assign_mac = 1'd1 ;

  // rule RL_iic_go_set
  assign CAN_FIRE_RL_iic_go_set =
	     cycleCount[28] && !iicGo && !iicDone && macAddrRead ;
  ...
  // rule RL_read_iiceeprom_resp
  assign CAN_FIRE_RL_read_iiceeprom_resp =
	     i2cC_fResponse_EMPTY_N && !macAddrRead ;
  assign WILL_FIRE_RL_read_iiceeprom_resp = CAN_FIRE_RL_read_iiceeprom_resp ;
  ...
  assign CAN_FIRE_RL_response_iicrom =
	     ...
	     (iicrom_serverAdapter_outDataCore_EMPTY_N ||
	      iicrom_serverAdapter_outData_enqData_whas) &&
	     iicrom_serverAdapter_outData_outData_whas ;
  assign WILL_FIRE_RL_response_iicrom =
	     CAN_FIRE_RL_response_iicrom && !WILL_FIRE_RL_read_iiceeprom_req ;
  ...
  assign MUX_i2cC_fRequest_enq_1__VAL_1 =
	     selEepromOK ?
	       { 1'd0, slaveaddr__h51237, macAddrCnt[7:0], 8'h0 } :
	       24'd15992840 ;
  assign MUX_i2cC_fRequest_enq_1__VAL_2 =
	     { 1'd1, v__h52775[23:17], v__h52775[15:0] } ;
  assign MUX_i2cC_rOutEn_write_1__VAL_1 =
	     _154742503901866210315206599__q7[i2cC_rPlayIndex_Q_OUT[6:0]] ;
  assign MUX_i2cC_rOutEn_write_1__VAL_2 =
	     _166153498389916941667817601160445959__q8[i2cC_rPlayIndex_Q_OUT[6:0]] ;
  assign MUX_i2cC_rSCL_write_1__VAL_1 =
	     _121583396715528419856163987__q9[i2cC_rPlayIndex_Q_OUT[6:0]] ;
  assign MUX_i2cC_rSCL_write_1__VAL_2 =
	     _130549178157447095380771276656813203__q10[i2cC_rPlayIndex_Q_OUT[6:0]] ;
  assign MUX_i2cC_rSDA_write_1__VAL_1 =
	     wRdData__h1755[i2cC_rPlayIndex_Q_OUT[6:0]] ;
  assign MUX_i2cC_rSDA_write_1__VAL_2 =
	     wWrData__h1759[i2cC_rPlayIndex_Q_OUT[6:0]] ;

  // inlined wires
  assign iicTG_1_wget =
	     i2cC_fResponse_D_OUT == 8'h35 || i2cC_fResponse_D_OUT == 8'hAC ||
	     i2cC_fResponse_D_OUT == 8'h60 ;
  ...
  // register iicTG
  assign iicTG_D_IN = CAN_FIRE_RL_read_iiceeprom_resp && iicTG_1_wget ;
  ...
  // register macAddrCnt
  assign macAddrCnt_D_IN =
	     (macAddrCnt == 11'd1023) ? macAddrCnt : macAddrCnt + 11'd1 ;
  assign macAddrCnt_EN = WILL_FIRE_RL_read_iiceeprom_req && selEepromOK ;

  // register macAddrRead
  assign macAddrRead_D_IN = macAddrRespCnt == 11'd1023 ;
  assign macAddrRead_EN = CAN_FIRE_RL_read_iiceeprom_resp ;

  // register macAddrRespCnt
  assign macAddrRespCnt_D_IN =
	     (macAddrRespCnt == 11'd1023) ?
	       macAddrRespCnt :
	       macAddrRespCnt + 11'd1 ;
  assign macAddrRespCnt_EN = CAN_FIRE_RL_read_iiceeprom_resp ;

  // register macV
  assign macV_D_IN = { macV[39:0], i2cC_fResponse_D_OUT } ;
  assign macV_EN = CAN_FIRE_RL_read_iiceeprom_resp ;

  // register mdi_rMDC
  assign mdi_rMDC_D_IN =
	     _1434766110945527031733894725304609466537681244_ETC__q16[mdi_rPlayIndex_Q_OUT] ;
  assign mdi_rMDC_EN = CAN_FIRE_RL_mdi_run_frame ;

  // register mdi_rMDD
  assign mdi_rMDD_D_IN = bs__h21762[mdi_rPlayIndex_Q_OUT] ;
  assign mdi_rMDD_EN = CAN_FIRE_RL_mdi_run_frame ;

  // register mdi_rOutEn
  assign mdi_rOutEn_D_IN = bs__h34521[mdi_rPlayIndex_Q_OUT] ;
  ...
  // register selEepromOK
  assign selEepromOK_D_IN = 1'd1 ;
  assign selEepromOK_EN = WILL_FIRE_RL_read_iiceeprom_req && !selEepromOK ;
  ...
  // submodule i2cC_fRequest
  assign i2cC_fRequest_D_IN =
	     WILL_FIRE_RL_read_iiceeprom_req ?
	       MUX_i2cC_fRequest_enq_1__VAL_1 :
	       MUX_i2cC_fRequest_enq_1__VAL_2 ;
  assign i2cC_fRequest_ENQ =
	     WILL_FIRE_RL_read_iiceeprom_req || WILL_FIRE_RL_response_iicrom ;
  ...
  assign i2cC_fResponse_DEQ = CAN_FIRE_RL_read_iiceeprom_resp ;
  ...
  // submodule lcd_ctrl
  assign lcd_ctrl_setLine1_text = 128'h2073616C7441206661654C207478654E ;
  assign lcd_ctrl_setLine2_text = 128'h4B4F20646574696E69204349492D324C ;
  ...
  // submodule mdi_fResponse
  assign mdi_fResponse_D_IN = { 1'd1, x_data__h37798 } ;
  ...
  assign qcl2_inF_D_IN =
	     { CASE_crt2axicrtS0_response_get_BITS_39_TO_38__ETC__q17,
	       ...
	       CASE_crt2axicrtS0_response_get_BITS_19_TO_18__ETC__q19,
  ...
  assign IF_l2qc_sr_06_BITS_9_TO_8_18_EQ_0_19_OR_l2qc_s_ETC___d328 =
	     { CASE_l2qc_sr_BITS_9_TO_8_0_l2qc_sr_BITS_9_TO_8_ETC__q2,
	       l2qc_sr[7:0] } ;
  assign _121583396715528419856163987__q9 = 87'h6492492492492492492493 ;
  assign _130549178157447095380771276656813203__q10 =
	     117'h192492492492492E92492492492493 ;
  assign _1434766110945527031733894725304609466537681244_ETC__q16 =
	     195'h2492492492492492492492492492492492492492492492492 ;
  assign _154742503901866210315206599__q7 = 87'h7FFFFFF1FFFFFE3FFFFFC7 ;
  assign _166153498389916941667817601160445959__q8 =
	     117'h1FFFFFFC7FFFFF8FFFFFFE00000007 ;
  assign _306783360_BIT_i2cC_rPlayIndex_value__8_BITS_6__ETC___d108 =
	     _306783360__q4[i2cC_rPlayIndex_Q_OUT[6:0]] ;
  assign _306783360__q4 = 117'd306783360 ;
  assign _643371375338640__q21 =
	     195'h0000000000000000000000000000000000002492492492490 ;
  assign a0__h1744 = {3{i2cC_rAddress[0]}} ;
  assign a1__h1743 = {3{i2cC_rAddress[1]}} ;
  assign a2__h1742 = {3{i2cC_rAddress[2]}} ;
  assign a3__h1741 = {3{i2cC_rAddress[3]}} ;
  assign a4__h1740 = {3{i2cC_rAddress[4]}} ;
  assign a5__h1739 = {3{i2cC_rAddress[5]}} ;
  assign a6__h1738 = {3{i2cC_rAddress[6]}} ;
  assign a7__h1737 = {3{i2cC_rAddress[7]}} ;
  assign bs__h21762 =
	     { mdi_rWrite ?
  ...
  assign d0__h1753 = {3{i2cC_rWriteData[0]}} ;
  assign d0__h21388 = {3{mdi_rWriteData[0]}} ;
  assign d10__h21378 = {3{mdi_rWriteData[10]}} ;
  assign d11__h21377 = {3{mdi_rWriteData[11]}} ;
  assign d12__h21376 = {3{mdi_rWriteData[12]}} ;
  assign d13__h21375 = {3{mdi_rWriteData[13]}} ;
  assign d14__h21374 = {3{mdi_rWriteData[14]}} ;
  assign d15__h21373 = {3{mdi_rWriteData[15]}} ;
  assign d1__h1752 = {3{i2cC_rWriteData[1]}} ;
  assign d1__h21387 = {3{mdi_rWriteData[1]}} ;
  assign d2__h1751 = {3{i2cC_rWriteData[2]}} ;
  assign d2__h21386 = {3{mdi_rWriteData[2]}} ;
  assign d3__h1750 = {3{i2cC_rWriteData[3]}} ;
  assign d3__h21385 = {3{mdi_rWriteData[3]}} ;
  assign d4__h1749 = {3{i2cC_rWriteData[4]}} ;
  assign d4__h21384 = {3{mdi_rWriteData[4]}} ;
  assign d5__h1748 = {3{i2cC_rWriteData[5]}} ;
  assign d5__h21383 = {3{mdi_rWriteData[5]}} ;
  assign d6__h1747 = {3{i2cC_rWriteData[6]}} ;
  assign d6__h21382 = {3{mdi_rWriteData[6]}} ;
  assign d7__h1746 = {3{i2cC_rWriteData[7]}} ;
  assign d7__h21381 = {3{mdi_rWriteData[7]}} ;
  assign d8__h21380 = {3{mdi_rWriteData[8]}} ;
  assign d9__h21379 = {3{mdi_rWriteData[9]}} ;
  assign iicrom_serverAdapter_cnt_83_PLUS_IF_iicrom_ser_ETC___d589 =
	     iicrom_serverAdapter_cnt +
	     (WILL_FIRE_RL_iicrom_serverAdapter_stageReadResponseAlways ?
		3'd1 :
		3'd0) +
	     (WILL_FIRE_RL_response_iicrom ? 3'd7 : 3'd0) ;
  assign pa0__h21365 = {3{mdi_rPhyAddr[0]}} ;
  assign pa1__h21364 = {3{mdi_rPhyAddr[1]}} ;
  assign pa2__h21363 = {3{mdi_rPhyAddr[2]}} ;
  assign pa3__h21362 = {3{mdi_rPhyAddr[3]}} ;
  assign pa4__h21361 = {3{mdi_rPhyAddr[4]}} ;
  assign ra0__h21371 = {3{mdi_rRegAddr[0]}} ;
  assign ra1__h21370 = {3{mdi_rRegAddr[1]}} ;
  assign ra2__h21369 = {3{mdi_rRegAddr[2]}} ;
  assign ra3__h21368 = {3{mdi_rRegAddr[3]}} ;
  assign ra4__h21367 = {3{mdi_rRegAddr[4]}} ;
  assign s0__h1735 = {3{i2cC_rSlaveAddr[0]}} ;
  assign s1__h1734 = {3{i2cC_rSlaveAddr[1]}} ;
  assign s2__h1733 = {3{i2cC_rSlaveAddr[2]}} ;
  assign s3__h1732 = {3{i2cC_rSlaveAddr[3]}} ;
  assign s4__h1731 = {3{i2cC_rSlaveAddr[4]}} ;
  assign s5__h1730 = {3{i2cC_rSlaveAddr[5]}} ;
  assign s6__h1729 = {3{i2cC_rSlaveAddr[6]}} ;
  assign slaveaddr__h51237 = { 5'b10101, macAddrCnt[9:8] } ;
  assign v__h52775 =
	     iicrom_serverAdapter_outDataCore_EMPTY_N ?
	       iicrom_serverAdapter_outDataCore_D_OUT :
	       iicrom_memory_DO ;
  assign wRdData__h1755 =
	     { 3'b100,
	       s6__h1729,
	       s5__h1730,
	       s4__h1731,
  ...
  begin
    case (l2P_server_response_get[9:8])
      ...
      2'd3: CASE_l2Pserver_response_get_BITS_9_TO_8_0_l2P_ETC__q11 = 2'd3;
    endcase
  end
  ...
  begin
    case (qcl2_outF_D_OUT[9:8])
	  ...
	  CASE_qcl2_outFD_OUT_BITS_9_TO_8_0_qcl2_outFD_ETC__q12 =
	      qcl2_outF_D_OUT[9:8];
      2'd3: CASE_qcl2_outFD_OUT_BITS_9_TO_8_0_qcl2_outFD_ETC__q12 = 2'd3;
    endcase
  end
  always@(gmac_rx_get)
  begin
    case (gmac_rx_get[9:8])
	  ...
	  CASE_gmacrx_get_BITS_9_TO_8_0_gmacrx_get_BIT_ETC__q13 =
	      gmac_rx_get[9:8];
      2'd3: CASE_gmacrx_get_BITS_9_TO_8_0_gmacrx_get_BIT_ETC__q13 = 2'd3;
    endcase
  end
  ...
  begin
    case (l2P_client_request_get[9:8])
      ...
      2'd3: CASE_l2Pclient_request_get_BITS_9_TO_8_0_l2P_ETC__q14 = 2'd3;
    endcase
  end
  always@(l2qc_sr)
  begin
    case (l2qc_sr[29:28])
	  ...
	  CASE_l2qc_sr_BITS_29_TO_28_0_l2qc_sr_BITS_29_T_ETC__q15 =
	      l2qc_sr[29:28];
      2'd3: CASE_l2qc_sr_BITS_29_TO_28_0_l2qc_sr_BITS_29_T_ETC__q15 = 2'd3;
    endcase
  end
  ...
  begin
    case (crt2axi_crtS0_response_get[39:38])
      ...
      2'd3: CASE_crt2axicrtS0_response_get_BITS_39_TO_38__ETC__q17 = 2'd3;
    endcase
  end
  always@(crt2axi_crtS0_response_get)
  begin
    case (crt2axi_crtS0_response_get[29:28])
      ...
      2'd3: CASE_crt2axicrtS0_response_get_BITS_29_TO_28__ETC__q18 = 2'd3;
    endcase
  end
  always@(crt2axi_crtS0_response_get)
  begin
    case (crt2axi_crtS0_response_get[19:18])
      ...
      2'd3: CASE_crt2axicrtS0_response_get_BITS_19_TO_18__ETC__q19 = 2'd3;
    endcase
  end
  always@(crt2axi_crtS0_response_get)
  begin
    case (crt2axi_crtS0_response_get[9:8])
      ...
      2'd3: CASE_crt2axicrtS0_response_get_BITS_9_TO_8_0__ETC__q20 = 2'd3;
    endcase
  end
