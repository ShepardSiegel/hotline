...
module design_1
  ...
  assign mdio_mdc = mkl2hcrt_1_mdi_tmdc_io;
  ...
  xVIA mdio_mdd_via (mdio_mdd, Net);
...
design_1_mkL2HCrt_1_0 mkL2HCrt_1
       (.gmii_col_i(mkl2hcrt_1_gmii_COL),
        .gmii_crs_i(mkl2hcrt_1_gmii_CRS),
        .gmii_rstn(mkl2hcrt_1_gmii_rstn),
        .gmii_rx_clk(mkl2hcrt_1_gmii_RX_CLK),
        .gmii_rx_rx_dv_i(mkl2hcrt_1_gmii_RX_DV),
        .gmii_rx_rx_er_i(mkl2hcrt_1_gmii_RX_ER),
        .gmii_rx_rxd_i(mkl2hcrt_1_gmii_RXD),
        .gmii_tx_tx_clk(mkl2hcrt_1_gmii_GTX_CLK),
        .gmii_tx_tx_en(mkl2hcrt_1_gmii_TX_EN),
        .gmii_tx_tx_er(mkl2hcrt_1_gmii_TX_ER),
        .gmii_tx_txd(mkl2hcrt_1_gmii_TXD),
        ...
        .mdi_tMDC_IO(mkl2hcrt_1_mdi_tmdc_io),
        .mdi_tMDD_IO(Net),
        .sys0_clk(sys0_clk_1),
        .sys0_rst(sys0_rst_1),
