...
#ifndef __mkCRTServToA4LM_h__
#define __mkCRTServToA4LM_h__
...
/* Class declaration for the mkCRTServToA4LM module */
class MOD_mkCRTServToA4LM : public Module {
 ...
 /* Constructor */
 public:
  MOD_mkCRTServToA4LM(tSimStateHdl simHdl, char const *name, Module *parent);
 ...
 public:
  ...
  void dump_VCD(tVCDDumpType dt, unsigned int levels, MOD_mkCRTServToA4LM &backing);
  void vcd_defs(tVCDDumpType dt, MOD_mkCRTServToA4LM &backing);
  void vcd_prims(tVCDDumpType dt, MOD_mkCRTServToA4LM &backing);
};

#endif /* ifndef __mkCRTServToA4LM_h__ */
